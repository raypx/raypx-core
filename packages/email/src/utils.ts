...
// Utility functions
export const getStatusValue = (status: EmailStatus): string =>
  STATUS_MAP[status]
export const getProviderValue = (provider: EmailProvider): string =>
  PROVIDER_MAP[provider]
export const getEventTypeValue = (eventType: EmailEventType): string =>
